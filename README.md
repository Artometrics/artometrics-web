...
| `npm run render:readmitted` | Export readmitted chart PNGs via R (FRBSF-style academic palette) |
| `npm run render:readmitted:py` | Same charts via Python/kaleido (fallback) |
