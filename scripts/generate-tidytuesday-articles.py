...
DATASETS: list[DatasetSpec] = [
    ...
    DatasetSpec("project-gutenberg", "Project Gutenberg", "2025-06-03", None, ["culture", "history"]),
    ...
    DatasetSpec("languages-glottolog", "Languages of the World", "2025-12-23", "families.csv", ["atlas", "history"]),
    ...
    DatasetSpec("wealth-income", "Wealth and Income", "2021-02-09", None, ["power"]),
    ...
    DatasetSpec("web-page-metrics", "Web Page Metrics", "2022-11-15", None, ["culture", "power"]),
    DatasetSpec("biketown-bikeshare", "Biketown Bikeshare", "2018-06-05", None, ["atlas"]),
    ...
    DatasetSpec("all-the-pizza", "All The Pizza", "2019-10-01", None, ["culture"]),
]
