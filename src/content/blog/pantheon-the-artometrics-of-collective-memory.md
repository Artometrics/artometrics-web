---
title: "PANTHEON: The Artometrics of Collective Memory"
slug: pantheon-the-artometrics-of-collective-memory
pubDate: 2026-07-01
description: "A cultural data report using Pantheon-style biography data to ask who gets remembered, where memory clusters, and how fame travels across language, era, and institution."
heroImage: /images/content/articles/pantheon-the-artometrics-of-collective-memory/hero.png
...
<nav id="TOC" role="doc-toc">
  ...
  <li><a href="#memory-domains" id="toc-memory-domains">CHART 1 - MEMORY DOMAINS</a></li>
  <li><a href="#era-shift" id="toc-era-shift">CHART 2 - ERA SHIFT</a></li>
  <li><a href="#memory-capitals" id="toc-memory-capitals">CHART 3 - MEMORY CAPITALS</a></li>
  <li><a href="#two-clocks" id="toc-two-clocks">CHART 4 - TWO CLOCKS OF FAME</a></li>
  <li><a href="#archive-gap" id="toc-archive-gap">CHART 5 - ARCHIVE GAP</a></li>
