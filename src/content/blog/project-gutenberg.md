...
pubDate: 2026-06-15
description: "This report analyzes the TidyTuesday 2025-06-03 release on Project Gutenberg — 100,000 rows after cleaning and merge. The question is not whether the topic matters, but what the..."
...
<p class="art-p">This report analyzes the TidyTuesday <strong>2025-06-03</strong> release on <strong>Project Gutenberg</strong> — <strong>100,000</strong> rows after cleaning and merge. The question is not whether the topic matters, but what the distribution looks like when you stop quoting anecdotes and start counting.</p>
...
<p class="art-p">**PS** appears **4,684** times — the most recurring name in the file.</p>
<p class="art-p">The top dozen account for a visible share of all **100,000** rows.</p>
...
<p class="art-p">**lcsh** is the largest bucket with **69,027** records.</p>
...
<figure class="art-chart">
  <div class="art-chart-live" data-chart="/data/articles/project-gutenberg/charts/chart_pad_hist_1.plotly.json" data-fallback="/images/content/articles/project-gutenberg/charts/chart_pad_hist_1.png" role="img" aria-label="Frequency"></div>
  <figcaption class="art-chart-caption">Frequency</figcaption>
</figure>
<p class="art-p">Most subject entities appear once; repeat entries signal franchise depth.</p>
...
<figure class="art-chart">
  <div class="art-chart-live" data-chart="/data/articles/project-gutenberg/charts/chart_overview_1.plotly.json" data-fallback="/images/content/articles/project-gutenberg/charts/chart_overview_1.png" role="img" aria-label="Top Subject"></div>
  <figcaption class="art-chart-caption">Top Subject</figcaption>
</figure>
<p class="art-p">**PS** anchors the distribution with **4,684** records.</p>
