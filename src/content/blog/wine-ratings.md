...
slug: wine-ratings
pubDate: 2026-06-15
description: "This report analyzes the TidyTuesday 2019-05-28 release on Wine Ratings — 100,000 rows after cleaning and merge. The question is not whether the topic matters, but what the distribution..."
...
<p class="art-p">This report analyzes the TidyTuesday <strong>2019-05-28</strong> release on <strong>Wine Ratings</strong> — <strong>100,000</strong> rows after cleaning and merge. The question is not whether the topic matters, but what the distribution looks like when you stop quoting anecdotes and start counting.</p>
<p class="art-p">Five charts track <strong>Price</strong> across time, category, and named entities. Where a companion file exists in the repo, it is joined before analysis so reception, geography, or metadata columns are not left on the table.</p>
...
<figure class="art-chart">
  <div class="art-chart-live" data-chart="/data/articles/wine-ratings/charts/chart1_landscape.plotly.json" data-fallback="/images/content/articles/wine-ratings/charts/chart1_landscape.png" role="img" aria-label="Region 2 Mix"></div>
  <figcaption class="art-chart-caption">Region 2 Mix</figcaption>
</figure>
<p class="art-p">**Central Coast** dominates with **8,500** records — the structural center of gravity.</p>
<p class="art-p">Beyond the top ten sit **7** additional region 2 buckets in the long tail.</p>
<h2 id="chart-3-distribution" class="anchored">CHART 3 — DISTRIBUTION</h2>
<figure class="art-chart">
  <div class="art-chart-live" data-chart="/data/articles/wine-ratings/charts/chart3_distribution.plotly.json" data-fallback="/images/content/articles/wine-ratings/charts/chart3_distribution.png" role="img" aria-label="Price by Region 2"></div>
  <figcaption class="art-chart-caption">Price by Region 2</figcaption>
</figure>
<p class="art-p">Category boxes reveal whether price consensus is shared or contested across tiers.</p>
...
<figure class="art-chart">
  <div class="art-chart-live" data-chart="/data/articles/wine-ratings/charts/chart5_scatter.plotly.json" data-fallback="/images/content/articles/wine-ratings/charts/chart5_scatter.png" role="img" aria-label="Price vs Points"></div>
  <figcaption class="art-chart-caption">Price vs Points</figcaption>
</figure>
<p class="art-p">Joint plot of **price** and **points** surfaces clusters the averages erase.</p>
...
<figure class="art-chart">
  <div class="art-chart-live" data-chart="/data/articles/wine-ratings/charts/chart_pad_1.plotly.json" data-fallback="/images/content/articles/wine-ratings/charts/chart_pad_1.png" role="img" aria-label="Price Spread"></div>
  <figcaption class="art-chart-caption">Price Spread</figcaption>
</figure>
<p class="art-p">The middle half runs **17.0** to **42.0**.</p>
...
<p>Measured end to end, <strong>Wine Ratings</strong> rewards counting: the head, the tail, and the time trend rarely agree.</p><p>That tension is the Artometrics mandate — data does not replace judgment, it disciplines it.</p>
