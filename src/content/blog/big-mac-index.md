...
slug: big-mac-index
pubDate: 2026-06-15
description: "This report treats the TidyTuesday **2020-12-22** release as a measurable slice of big mac index — 1,386 records, 20 variables, one question: what does the distribution actually look like..."
...
<p class="art-p">This report treats the TidyTuesday **2020-12-22** release as a measurable slice of big mac index — 1,386 records, 20 variables, one question: what does the distribution actually look like when you stop reading anecdotes and start counting?</p>
<h2 id="fast-facts" class="anchored">FAST FACTS</h2>
<div class="facts-grid">
  <div class="fact-box">
    <span class="fact-number">1,386</span>
  ...
  <div class="fact-box">
    ...
    <span class="fact-label">Latest-period median dollar_price</span>
  </div>
  <div class="fact-box">
    <span class="fact-number">3.04</span>
    <span class="fact-label">Median dollar_price</span>
  </div>
  <div class="fact-box">
    <span class="fact-number">8.31</span>
    <span class="fact-label">Maximum observed dollar_price</span>
  </div>
</div>
<h2 id="dataset-context" class="anchored">DATASET CONTEXT</h2>
<p>The source data is the TidyTuesday release from <strong>2020-12-22</strong>, maintained by the R for Data Science community. The working dataset contains <strong>1,386</strong> rows and <strong>20</strong> columns. Files were pulled directly from the public repository without manual transcription.</p>
...
<figure class="art-chart">
  <div class="art-chart-live" data-chart="/data/articles/big-mac-index/charts/chart2_time_trend.plotly.json" data-fallback="/images/content/articles/big-mac-index/charts/chart2_time_trend.png" role="img" aria-label="Median Trend Over Time"></div>
  <figcaption class="art-chart-caption">Median Trend Over Time</figcaption>
</figure>
<p class="art-p">When `dollar_price` is tracked across time, the median moves from **1.73** in the earliest period to **3.50** in the latest — an upward drift visible in the aggregate.</p>
...
<p class="art-p">`dollar_price` centers around a median of **3.04** with a mean of **3.26**. The gap between those two numbers suggests right-skew — a few large values pulling the average up.</p>
...
<figure class="art-chart">
  <div class="art-chart-live" data-chart="/data/articles/big-mac-index/charts/chart4_top_ranked.plotly.json" data-fallback="/images/content/articles/big-mac-index/charts/chart4_top_ranked.png" role="img" aria-label="Top Name"></div>
  <figcaption class="art-chart-caption">Top Name</figcaption>
</figure>
<p class="art-p">At the top of the ranking, **Switzerland** posts a median `dollar_price` of **6.54** — separating itself from the median-of-medians baseline of **4.53**.</p>
...
<figure class="art-chart">
  <div class="art-chart-live" data-chart="/data/articles/big-mac-index/charts/chart_extra_1.plotly.json" data-fallback="/images/content/articles/big-mac-index/charts/chart_extra_1.png" role="img" aria-label="Dollar Price Spread"></div>
  <figcaption class="art-chart-caption">Dollar Price Spread</figcaption>
</figure>
<p class="art-p">The interquartile range of `dollar_price` runs from **2.34** to **4.01**.</p>
...
<figure class="art-chart">
  <div class="art-chart-live" data-chart="/data/articles/big-mac-index/charts/chart_extra_2.plotly.json" data-fallback="/images/content/articles/big-mac-index/charts/chart_extra_2.png" role="img" aria-label="Dollar Price Spread"></div>
  <figcaption class="art-chart-caption">Dollar Price Spread</figcaption>
</figure>
<p class="art-p">The interquartile range of `dollar_price` runs from **2.34** to **4.01**.</p>
<p class="art-p">Box-level compression means most records cluster tightly; long whiskers mean the extremes drive the narrative.</p>
...
<p>Five charts, one through-line: <strong>Big Mac Index</strong> looks different when you measure it. The headline categories, time trends, and tail behavior all matter — but they rarely tell the same story.</p><p>That tension is the point of Artometrics. The data does not replace judgment. It disciplines it.</p>
