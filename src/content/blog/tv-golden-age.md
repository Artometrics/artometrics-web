...
slug: tv-golden-age
pubDate: 2026-06-15
description: "This report treats the TidyTuesday **2019-01-08** release as a measurable slice of tv golden age — 2,266 records, 8 variables, one question: what does the distribution actually look like..."
...
<p class="art-p">This report treats the TidyTuesday **2019-01-08** release as a measurable slice of tv golden age — 2,266 records, 8 variables, one question: what does the distribution actually look like when you stop reading anecdotes and start counting?</p>
<h2 id="fast-facts" class="anchored">FAST FACTS</h2>
<div class="facts-grid">
  <div class="fact-box">
    <span class="fact-number">2,266</span>
  ...
  <div class="fact-box">
    <span class="fact-number">8.1</span>
    <span class="fact-label">Latest-period median av_rating</span>
  </div>
  <div class="fact-box">
    <span class="fact-number">8.11</span>
    <span class="fact-label">Median av_rating</span>
  </div>
  <div class="fact-box">
    <span class="fact-number">9.68</span>
    <span class="fact-label">Maximum observed av_rating</span>
  </div>
</div>
<h2 id="dataset-context" class="anchored">DATASET CONTEXT</h2>
<p>The source data is the TidyTuesday release from <strong>2019-01-08</strong>, maintained by the R for Data Science community. The working dataset contains <strong>2,266</strong> rows and <strong>8</strong> columns. Files were pulled directly from the public repository without manual transcription.</p>
...
<figure class="art-chart">
  <div class="art-chart-live" data-chart="/data/articles/tv-golden-age/charts/chart2_time_trend.plotly.json" data-fallback="/images/content/articles/tv-golden-age/charts/chart2_time_trend.png" role="img" aria-label="Median Trend Over Time"></div>
  <figcaption class="art-chart-caption">Median Trend Over Time</figcaption>
</figure>
<p class="art-p">When `av_rating` is tracked across time, the median moves from **7.85** in the earliest period to **8.15** in the latest — an upward drift visible in the aggregate.</p>
...
<p class="art-p">`av_rating` centers around a median of **8.11** with a mean of **8.06**. The gap between those two numbers suggests a relatively symmetric spread.</p>
...
<figure class="art-chart">
  <div class="art-chart-live" data-chart="/data/articles/tv-golden-age/charts/chart4_top_ranked.plotly.json" data-fallback="/images/content/articles/tv-golden-age/charts/chart4_top_ranked.png" role="img" aria-label="Top Titleid"></div>
  <figcaption class="art-chart-caption">Top Titleid</figcaption>
</figure>
<p class="art-p">At the top of the ranking, **tt0098887** posts a median `av_rating` of **9.68** — separating itself from the median-of-medians baseline of **9.27**.</p>
...
<figure class="art-chart">
  <div class="art-chart-live" data-chart="/data/articles/tv-golden-age/charts/chart_extra_1.plotly.json" data-fallback="/images/content/articles/tv-golden-age/charts/chart_extra_1.png" role="img" aria-label="Av Rating Spread"></div>
  <figcaption class="art-chart-caption">Av Rating Spread</figcaption>
</figure>
<p class="art-p">The interquartile range of `av_rating` runs from **7.73** to **8.49**.</p>
...
<figure class="art-chart">
  <div class="art-chart-live" data-chart="/data/articles/tv-golden-age/charts/chart_extra_2.plotly.json" data-fallback="/images/content/articles/tv-golden-age/charts/chart_extra_2.png" role="img" aria-label="Av Rating Spread"></div>
  <figcaption class="art-chart-caption">Av Rating Spread</figcaption>
</figure>
<p class="art-p">The interquartile range of `av_rating` runs from **7.73** to **8.49**.</p>
<p class="art-p">Box-level compression means most records cluster tightly; long whiskers mean the extremes drive the narrative.</p>
...
<p>Five charts, one through-line: <strong>TV Golden Age</strong> looks different when you measure it. The headline categories, time trends, and tail behavior all matter — but they rarely tell the same story.</p><p>That tension is the point of Artometrics. The data does not replace judgment. It disciplines it.</p>
