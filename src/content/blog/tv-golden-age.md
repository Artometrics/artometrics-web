...
slug: tv-golden-age
pubDate: 2026-06-15
description: "This report analyzes the TidyTuesday 2019-01-08 release on TV Golden Age — 2,266 rows after cleaning and merge. The question is not whether the topic matters, but what the distribution..."
...
<p class="art-p">This report analyzes the TidyTuesday <strong>2019-01-08</strong> release on <strong>TV Golden Age</strong> — <strong>2,266</strong> rows after cleaning and merge. The question is not whether the topic matters, but what the distribution looks like when you stop quoting anecdotes and start counting.</p>
<p class="art-p">Five charts track <strong>Av rating</strong> across time, category, and named entities. Where a companion file exists in the repo, it is joined before analysis so reception, geography, or metadata columns are not left on the table.</p>
...
<p class="art-p">The median av rating opens at **7.86** and closes at **8.15** across the series.</p>
...
<p class="art-p">Median **8.11** vs mean **8.06** — the shape is relatively symmetric.</p>
<p class="art-p">The top decile begins at **8.79**; that tail is where franchise-defining cases live.</p>
<h2 id="chart-4-leaders" class="anchored">CHART 4 — LEADERS</h2>
<figure class="art-chart">
  <div class="art-chart-live" data-chart="/data/articles/tv-golden-age/charts/chart4_leaders.plotly.json" data-fallback="/images/content/articles/tv-golden-age/charts/chart4_leaders.png" role="img" aria-label="Top Title"></div>
  <figcaption class="art-chart-caption">Top Title</figcaption>
</figure>
<p class="art-p">**Touched by an Angel** leads at **9.60** — **9.24** marks the median among the top dozen.</p>
...
<p class="art-p">Joint plot of **av rating** and **seasonnumber** surfaces clusters the averages erase.</p>
...
<figure class="art-chart">
  <div class="art-chart-live" data-chart="/data/articles/tv-golden-age/charts/chart_pad_1.plotly.json" data-fallback="/images/content/articles/tv-golden-age/charts/chart_pad_1.png" role="img" aria-label="Av rating Spread"></div>
  <figcaption class="art-chart-caption">Av rating Spread</figcaption>
</figure>
<p class="art-p">The middle half runs **7.73** to **8.49**.</p>
...
<p>Measured end to end, <strong>TV Golden Age</strong> rewards counting: the head, the tail, and the time trend rarely agree.</p><p>That tension is the Artometrics mandate — data does not replace judgment, it disciplines it.</p>
