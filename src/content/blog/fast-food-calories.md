...
pubDate: 2026-06-15
description: "This report treats the TidyTuesday **2018-09-04** release as a measurable slice of fast food calories — 515 records, 17 variables, one question: what does the distribution actually look..."
...
<p class="art-p">This report treats the TidyTuesday **2018-09-04** release as a measurable slice of fast food calories — 515 records, 17 variables, one question: what does the distribution actually look like when you stop reading anecdotes and start counting?</p>
<h2 id="fast-facts" class="anchored">FAST FACTS</h2>
<div class="facts-grid">
  <div class="fact-box">
    <span class="fact-number">515</span>
  ...
  <div class="fact-box">
    <span class="fact-number">490.00</span>
    <span class="fact-label">Median calories</span>
  </div>
  <div class="fact-box">
    <span class="fact-number">2,430.00</span>
    <span class="fact-label">Maximum observed calories</span>
  </div>
</div>
<h2 id="dataset-context" class="anchored">DATASET CONTEXT</h2>
<p>The source data is the TidyTuesday release from <strong>2018-09-04</strong>, maintained by the R for Data Science community. The working dataset contains <strong>515</strong> rows and <strong>17</strong> columns. Files were pulled directly from the public repository without manual transcription.</p>
...
<p class="art-p">`calories` centers around a median of **490.00** with a mean of **530.91**. The gap between those two numbers suggests right-skew — a few large values pulling the average up.</p>
...
<figure class="art-chart">
  <div class="art-chart-live" data-chart="/data/articles/fast-food-calories/charts/chart_extra_1.plotly.json" data-fallback="/images/content/articles/fast-food-calories/charts/chart_extra_1.png" role="img" aria-label="Calories Spread"></div>
  <figcaption class="art-chart-caption">Calories Spread</figcaption>
</figure>
<p class="art-p">The interquartile range of `calories` runs from **330.00** to **690.00**.</p>
...
<figure class="art-chart">
  <div class="art-chart-live" data-chart="/data/articles/fast-food-calories/charts/chart_extra_2.plotly.json" data-fallback="/images/content/articles/fast-food-calories/charts/chart_extra_2.png" role="img" aria-label="Calories Spread"></div>
  <figcaption class="art-chart-caption">Calories Spread</figcaption>
</figure>
<p class="art-p">The interquartile range of `calories` runs from **330.00** to **690.00**.</p>
<p class="art-p">Box-level compression means most records cluster tightly; long whiskers mean the extremes drive the narrative.</p>
...
<figure class="art-chart">
  <div class="art-chart-live" data-chart="/data/articles/fast-food-calories/charts/chart_extra_3.plotly.json" data-fallback="/images/content/articles/fast-food-calories/charts/chart_extra_3.png" role="img" aria-label="Calories Spread"></div>
  <figcaption class="art-chart-caption">Calories Spread</figcaption>
</figure>
<p class="art-p">The interquartile range of `calories` runs from **330.00** to **690.00**.</p>
<p class="art-p">Box-level compression means most records cluster tightly; long whiskers mean the extremes drive the narrative.</p>
...
<figure class="art-chart">
  <div class="art-chart-live" data-chart="/data/articles/fast-food-calories/charts/chart_extra_4.plotly.json" data-fallback="/images/content/articles/fast-food-calories/charts/chart_extra_4.png" role="img" aria-label="Calories Spread"></div>
  <figcaption class="art-chart-caption">Calories Spread</figcaption>
</figure>
<p class="art-p">The interquartile range of `calories` runs from **330.00** to **690.00**.</p>
<p class="art-p">Box-level compression means most records cluster tightly; long whiskers mean the extremes drive the narrative.</p>
...
<p>Five charts, one through-line: <strong>Fast Food Calories</strong> looks different when you measure it. The headline categories, time trends, and tail behavior all matter — but they rarely tell the same story.</p><p>That tension is the point of Artometrics. The data does not replace judgment. It disciplines it.</p>
