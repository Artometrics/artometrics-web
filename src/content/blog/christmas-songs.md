...
pubDate: 2026-06-15
description: "This report treats the TidyTuesday **2019-12-24** release as a measurable slice of christmas songs — 387 records, 13 variables, one question: what does the distribution actually look like..."
...
<p class="art-p">This report treats the TidyTuesday **2019-12-24** release as a measurable slice of christmas songs — 387 records, 13 variables, one question: what does the distribution actually look like when you stop reading anecdotes and start counting?</p>
<h2 id="fast-facts" class="anchored">FAST FACTS</h2>
<div class="facts-grid">
  <div class="fact-box">
    <span class="fact-number">387</span>
  ...
  <div class="fact-box">
    <span class="fact-number">42.5</span>
    <span class="fact-label">Latest-period median week_position</span>
  </div>
  <div class="fact-box">
    <span class="fact-number">58.00</span>
...
<p>The source data is the TidyTuesday release from <strong>2019-12-24</strong>, maintained by the R for Data Science community. The working dataset contains <strong>387</strong> rows and <strong>13</strong> columns. Files were pulled directly from the public repository without manual transcription.</p>
...
<figure class="art-chart">
  <div class="art-chart-live" data-chart="/data/articles/christmas-songs/charts/chart2_time_trend.plotly.json" data-fallback="/images/content/articles/christmas-songs/charts/chart2_time_trend.png" role="img" aria-label="Median Trend Over Time"></div>
  <figcaption class="art-chart-caption">Median Trend Over Time</figcaption>
</figure>
<p class="art-p">When `week_position` is tracked across time, the median moves from **91.00** in the earliest period to **42.50** in the latest — a downward drift visible in the aggregate.</p>
...
<p class="art-p">`week_position` centers around a median of **58.00** with a mean of **57.20**. The gap between those two numbers suggests a relatively symmetric spread.</p>
<p class="art-p">Roughly **8.5%** of records sit above the 90th percentile threshold — the tail is where exceptional cases live.</p>
<h2 id="chart-extra-1" class="anchored">CHART 3 — SPREAD</h2>
<figure class="art-chart">
  <div class="art-chart-live" data-chart="/data/articles/christmas-songs/charts/chart_extra_1.plotly.json" data-fallback="/images/content/articles/christmas-songs/charts/chart_extra_1.png" role="img" aria-label="Week Position Spread"></div>
  <figcaption class="art-chart-caption">Week Position Spread</figcaption>
</figure>
<p class="art-p">The interquartile range of `week_position` runs from **38.50** to **78.00**.</p>
...
<figure class="art-chart">
  <div class="art-chart-live" data-chart="/data/articles/christmas-songs/charts/chart_extra_2.plotly.json" data-fallback="/images/content/articles/christmas-songs/charts/chart_extra_2.png" role="img" aria-label="Week Position Spread"></div>
  <figcaption class="art-chart-caption">Week Position Spread</figcaption>
</figure>
<p class="art-p">The interquartile range of `week_position` runs from **38.50** to **78.00**.</p>
<p class="art-p">Box-level compression means most records cluster tightly; long whiskers mean the extremes drive the narrative.</p>
...
<figure class="art-chart">
  <div class="art-chart-live" data-chart="/data/articles/christmas-songs/charts/chart_extra_3.plotly.json" data-fallback="/images/content/articles/christmas-songs/charts/chart_extra_3.png" role="img" aria-label="Week Position Spread"></div>
  <figcaption class="art-chart-caption">Week Position Spread</figcaption>
</figure>
<p class="art-p">The interquartile range of `week_position` runs from **38.50** to **78.00**.</p>
<p class="art-p">Box-level compression means most records cluster tightly; long whiskers mean the extremes drive the narrative.</p>
...
<p>Five charts, one through-line: <strong>Christmas Songs</strong> looks different when you measure it. The headline categories, time trends, and tail behavior all matter — but they rarely tell the same story.</p><p>That tension is the point of Artometrics. The data does not replace judgment. It disciplines it.</p>
