...
pubDate: 2026-06-15
description: "This report treats the TidyTuesday **2018-06-26** release as a measurable slice of alcohol consumption — 193 records, 5 variables, one question: what does the distribution actually look..."
...
<p class="art-p">This report treats the TidyTuesday **2018-06-26** release as a measurable slice of alcohol consumption — 193 records, 5 variables, one question: what does the distribution actually look like when you stop reading anecdotes and start counting?</p>
<h2 id="fast-facts" class="anchored">FAST FACTS</h2>
<div class="facts-grid">
  <div class="fact-box">
    <span class="fact-number">193</span>
  ...
  <div class="fact-box">
    <span class="fact-number">76.00</span>
    <span class="fact-label">Median beer_servings</span>
  </div>
  <div class="fact-box">
    <span class="fact-number">376.00</span>
    <span class="fact-label">Maximum observed beer_servings</span>
  </div>
</div>
<h2 id="dataset-context" class="anchored">DATASET CONTEXT</h2>
<p>The source data is the TidyTuesday release from <strong>2018-06-26</strong>, maintained by the R for Data Science community. The working dataset contains <strong>193</strong> rows and <strong>5</strong> columns. Files were pulled directly from the public repository without manual transcription.</p>
...
<p class="art-p">`beer_servings` centers around a median of **76.00** with a mean of **106.16**. The gap between those two numbers suggests right-skew — a few large values pulling the average up.</p>
...
<figure class="art-chart">
  <div class="art-chart-live" data-chart="/data/articles/alcohol-consumption/charts/chart4_top_ranked.plotly.json" data-fallback="/images/content/articles/alcohol-consumption/charts/chart4_top_ranked.png" role="img" aria-label="Top Country"></div>
  <figcaption class="art-chart-caption">Top Country</figcaption>
</figure>
<p class="art-p">At the top of the ranking, **Namibia** posts a median `beer_servings` of **376.00** — separating itself from the median-of-medians baseline of **338.00**.</p>
...
<figure class="art-chart">
  <div class="art-chart-live" data-chart="/data/articles/alcohol-consumption/charts/chart_extra_1.plotly.json" data-fallback="/images/content/articles/alcohol-consumption/charts/chart_extra_1.png" role="img" aria-label="Beer Servings Spread"></div>
  <figcaption class="art-chart-caption">Beer Servings Spread</figcaption>
</figure>
<p class="art-p">The interquartile range of `beer_servings` runs from **20.00** to **188.00**.</p>
...
<figure class="art-chart">
  <div class="art-chart-live" data-chart="/data/articles/alcohol-consumption/charts/chart_extra_2.plotly.json" data-fallback="/images/content/articles/alcohol-consumption/charts/chart_extra_2.png" role="img" aria-label="Beer Servings Spread"></div>
  <figcaption class="art-chart-caption">Beer Servings Spread</figcaption>
</figure>
<p class="art-p">The interquartile range of `beer_servings` runs from **20.00** to **188.00**.</p>
<p class="art-p">Box-level compression means most records cluster tightly; long whiskers mean the extremes drive the narrative.</p>
...
<figure class="art-chart">
  <div class="art-chart-live" data-chart="/data/articles/alcohol-consumption/charts/chart_extra_3.plotly.json" data-fallback="/images/content/articles/alcohol-consumption/charts/chart_extra_3.png" role="img" aria-label="Beer Servings Spread"></div>
  <figcaption class="art-chart-caption">Beer Servings Spread</figcaption>
</figure>
<p class="art-p">The interquartile range of `beer_servings` runs from **20.00** to **188.00**.</p>
<p class="art-p">Box-level compression means most records cluster tightly; long whiskers mean the extremes drive the narrative.</p>
...
<p>Five charts, one through-line: <strong>Alcohol Consumption</strong> looks different when you measure it. The headline categories, time trends, and tail behavior all matter — but they rarely tell the same story.</p><p>That tension is the point of Artometrics. The data does not replace judgment. It disciplines it.</p>
