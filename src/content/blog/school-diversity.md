...
<figure class="art-chart">
  <div class="art-chart-live" data-chart="/data/articles/school-diversity/charts/chart4_category_compare.plotly.json" data-fallback="/images/content/articles/school-diversity/charts/chart4_category_compare.png" role="img" aria-label="Multi by ST"></div>
  <figcaption class="art-chart-caption">Multi by ST</figcaption>
</figure>
<p class="art-p"><strong>OK</strong> leads the median table at <strong>6.62</strong>; the gap to <strong>NJ</strong> is <strong>5.06</strong> points.</p>
...
<p>Community-cleaned TidyTuesday snapshots are not live APIs. Missing values, spelling variants, and week-of-export coverage limits apply. Merged tables may fan out or duplicate rows when join keys are imperfect.</p><p>Findings describe the file on hand — treat them as structural signals about <strong>School Diversity</strong>, not exhaustive truth about the full domain.</p>
<h2 id="conclusion" class="anchored">CONCLUSION</h2>
<p>Measured end to end, <strong>School Diversity</strong> rewards counting: the leaders, the long tail, and the time trend rarely tell the same story about multi.</p><p>That tension is the Artometrics mandate — data does not replace judgment, it disciplines it.</p>
