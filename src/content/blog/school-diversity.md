...
pubDate: 2026-06-15
description: "This report analyzes the TidyTuesday 2019-09-24 release on School Diversity — 27,944 rows after cleaning and merge. The question is not whether the topic matters, but what the..."
...
<figure class="art-chart">
  <div class="art-chart-live" data-chart="/data/articles/school-diversity/charts/chart1_landscape.plotly.json" data-fallback="/images/content/articles/school-diversity/charts/chart1_landscape.png" role="img" aria-label="D Locale Txt Mix"></div>
  <figcaption class="art-chart-caption">D Locale Txt Mix</figcaption>
</figure>
<p class="art-p">**rural-distant** dominates with **5,987** records — the structural center of gravity.</p>
...
<p>Measured end to end, <strong>School Diversity</strong> rewards counting: the head, the tail, and the time trend rarely agree.</p><p>That tension is the Artometrics mandate — data does not replace judgment, it disciplines it.</p>
