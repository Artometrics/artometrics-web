...
pubDate: 2026-06-15
description: "This report analyzes the TidyTuesday 2018-10-16 release on College Major & Income — 173 rows after cleaning and merge. The question is not whether the topic matters, but what the..."
...
<p class="art-p">This report analyzes the TidyTuesday <strong>2018-10-16</strong> release on <strong>College Major & Income</strong> — <strong>173</strong> rows after cleaning and merge. The question is not whether the topic matters, but what the distribution looks like when you stop quoting anecdotes and start counting.</p>
<p class="art-p">Five charts track <strong>Low wage jobs</strong> across time, category, and named entities. Where a companion file exists in the repo, it is joined before analysis so reception, geography, or metadata columns are not left on the table.</p>
...
<figure class="art-chart">
  <div class="art-chart-live" data-chart="/data/articles/college-major-income/charts/chart1_landscape.plotly.json" data-fallback="/images/content/articles/college-major-income/charts/chart1_landscape.png" role="img" aria-label="Major category Mix"></div>
  <figcaption class="art-chart-caption">Major category Mix</figcaption>
</figure>
<p class="art-p">**Engineering** dominates with **29** records — the structural center of gravity.</p>
<p class="art-p">Beyond the top ten sit **6** additional major category buckets in the long tail.</p>
<h2 id="chart-3-distribution" class="anchored">CHART 3 — DISTRIBUTION</h2>
<figure class="art-chart">
  <div class="art-chart-live" data-chart="/data/articles/college-major-income/charts/chart3_distribution.plotly.json" data-fallback="/images/content/articles/college-major-income/charts/chart3_distribution.png" role="img" aria-label="Low wage jobs by Major category"></div>
  <figcaption class="art-chart-caption">Low wage jobs by Major category</figcaption>
</figure>
...
<figure class="art-chart">
  <div class="art-chart-live" data-chart="/data/articles/college-major-income/charts/chart5_scatter.plotly.json" data-fallback="/images/content/articles/college-major-income/charts/chart5_scatter.png" role="img" aria-label="Low wage jobs vs Unemployment rate"></div>
  <figcaption class="art-chart-caption">Low wage jobs vs Unemployment rate</figcaption>
</figure>
<p class="art-p">Joint plot of **low wage jobs** and **unemployment rate** surfaces clusters the averages erase.</p>
...
<figure class="art-chart">
  <div class="art-chart-live" data-chart="/data/articles/college-major-income/charts/chart_pad_1.plotly.json" data-fallback="/images/content/articles/college-major-income/charts/chart_pad_1.png" role="img" aria-label="Low wage jobs Spread"></div>
  <figcaption class="art-chart-caption">Low wage jobs Spread</figcaption>
</figure>
<p class="art-p">The middle half runs **340** to **3,466**.</p>
...
<p>Measured end to end, <strong>College Major & Income</strong> rewards counting: the head, the tail, and the time trend rarely agree.</p><p>That tension is the Artometrics mandate — data does not replace judgment, it disciplines it.</p>
