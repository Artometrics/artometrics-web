...
slug: craft-beer-usa
pubDate: 2026-06-15
description: "This report analyzes the TidyTuesday 2018-07-10 release on Craft Beer USA — 2,410 rows after cleaning and merge. The question is not whether the topic matters, but what the distribution..."
...
<p class="art-p">This report analyzes the TidyTuesday <strong>2018-07-10</strong> release on <strong>Craft Beer USA</strong> — <strong>2,410</strong> rows after cleaning and merge. The question is not whether the topic matters, but what the distribution looks like when you stop quoting anecdotes and start counting.</p>
<p class="art-p">Five charts track <strong>Abv</strong> across time, category, and named entities. Where a companion file exists in the repo, it is joined before analysis so reception, geography, or metadata columns are not left on the table.</p>
...
<figure class="art-chart">
  <div class="art-chart-live" data-chart="/data/articles/craft-beer-usa/charts/chart3_distribution.plotly.json" data-fallback="/images/content/articles/craft-beer-usa/charts/chart3_distribution.png" role="img" aria-label="Abv Distribution"></div>
  <figcaption class="art-chart-caption">Abv Distribution</figcaption>
</figure>
<p class="art-p">Median **0.06** vs mean **0.06** — the shape is right-skewed.</p>
<p class="art-p">The top decile begins at **0.08**; that tail is where franchise-defining cases live.</p>
<h2 id="chart-4-leaders" class="anchored">CHART 4 — LEADERS</h2>
<figure class="art-chart">
  <div class="art-chart-live" data-chart="/data/articles/craft-beer-usa/charts/chart4_leaders.plotly.json" data-fallback="/images/content/articles/craft-beer-usa/charts/chart4_leaders.png" role="img" aria-label="Top Name"></div>
  <figcaption class="art-chart-caption">Top Name</figcaption>
</figure>
<p class="art-p">**Lee Hill Series Vol. 5 - Belgian Style Quadrupel Ale** leads at **0.13** — **0.10** marks the median among the top dozen.</p>
...
<p class="art-p">Joint plot of **abv** and **ibu** surfaces clusters the averages erase.</p>
...
<figure class="art-chart">
  <div class="art-chart-live" data-chart="/data/articles/craft-beer-usa/charts/chart_pad_1.plotly.json" data-fallback="/images/content/articles/craft-beer-usa/charts/chart_pad_1.png" role="img" aria-label="Abv Spread"></div>
  <figcaption class="art-chart-caption">Abv Spread</figcaption>
</figure>
<p class="art-p">The middle half runs **0.05** to **0.07**.</p>
...
<figure class="art-chart">
  <div class="art-chart-live" data-chart="/data/articles/craft-beer-usa/charts/chart_pad_2.plotly.json" data-fallback="/images/content/articles/craft-beer-usa/charts/chart_pad_2.png" role="img" aria-label="Abv Spread"></div>
  <figcaption class="art-chart-caption">Abv Spread</figcaption>
</figure>
<p class="art-p">The middle half runs **0.05** to **0.07**.</p>
<p class="art-p">Tight boxes mean consensus; long whiskers mean extremes own the narrative.</p>
...
<p>Measured end to end, <strong>Craft Beer USA</strong> rewards counting: the head, the tail, and the time trend rarely agree.</p><p>That tension is the Artometrics mandate — data does not replace judgment, it disciplines it.</p>
