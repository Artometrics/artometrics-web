...
<p class="art-p">**Lemonade Film (Script)** appears **336** times — the most recurring name in the file.</p>
<p class="art-p">The top dozen account for a visible share of all **22,616** rows.</p>
...
<p class="art-p">**If I let you go** is the most repeated line in the extract.</p>
...
<figure class="art-chart">
  <div class="art-chart-live" data-chart="/data/articles/beyonce-taylor-lyrics/charts/chart_pad_hist_1.plotly.json" data-fallback="/images/content/articles/beyonce-taylor-lyrics/charts/chart_pad_hist_1.png" role="img" aria-label="Frequency"></div>
  <figcaption class="art-chart-caption">Frequency</figcaption>
</figure>
<p class="art-p">Most song name entities appear once; repeat entries signal franchise depth.</p>
...
<figure class="art-chart">
  <div class="art-chart-live" data-chart="/data/articles/beyonce-taylor-lyrics/charts/chart_overview_1.plotly.json" data-fallback="/images/content/articles/beyonce-taylor-lyrics/charts/chart_overview_1.png" role="img" aria-label="Top Song name"></div>
  <figcaption class="art-chart-caption">Top Song name</figcaption>
</figure>
<p class="art-p">**Lemonade Film (Script)** anchors the distribution with **336** records.</p>
