...
<figure class="art-chart">
  <div class="art-chart-live" data-chart="/data/articles/biketown-bikeshare/charts/chart4_category_compare.plotly.json" data-fallback="/images/content/articles/biketown-bikeshare/charts/chart4_category_compare.png" role="img" aria-label="Duration min by TripType"></div>
  <figcaption class="art-chart-caption">Duration min by TripType</figcaption>
</figure>
<p class="art-p"><strong>recreation</strong> leads the median table at <strong>32.6</strong>; the gap to <strong>work</strong> is <strong>21.2</strong> points.</p>
