...
<figure class="art-chart">
  <div class="art-chart-live" data-chart="/data/articles/board-games/charts/chart4_category_compare.plotly.json" data-fallback="/images/content/articles/board-games/charts/chart4_category_compare.png" role="img" aria-label="Average rating by Category"></div>
  <figcaption class="art-chart-caption">Average rating by Category</figcaption>
</figure>
<p class="art-p"><strong>American Civil War,Wargame</strong> leads the median table at <strong>7.05</strong>; the gap to <strong>Card Game</strong> is <strong>1.02</strong> points.</p>
