...
<p>The interpretive frame draws on media-industry work by Ian Condry, Rayna Denison, Marc Steinberg, and Jonathan Clements because the dataset’s statistical patterns map onto known institutional changes: television production committees, light-novel and manga source pipelines, global streaming distribution, and the media-mix system that turns characters and franchises into cross-platform assets. Those citations help keep the charts grounded in actual anime-industry history rather than treating MAL scores as free-floating taste metrics.</p>
