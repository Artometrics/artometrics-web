---
title: "PROJECT GUTENBERG: The Artometrics of the Public-Domain Canon"
slug: project-gutenberg-public-domain-canon-map
pubDate: 2026-07-01
description: "A literary culture report using Project Gutenberg metadata logic to map language gravity, era effects, author memory, adaptation power, and remix value."
...
<nav id="TOC" role="doc-toc">
  ...
  <li><a href="#language-gravity" id="toc-language-gravity">CHART 1 - LANGUAGE GRAVITY</a></li>
  <li><a href="#era-machine" id="toc-era-machine">CHART 2 - ERA MACHINE</a></li>
  <li><a href="#author-memory" id="toc-author-memory">CHART 3 - AUTHOR MEMORY</a></li>
  <li><a href="#adaptation" id="toc-adaptation">CHART 4 - ADAPTATION POWER</a></li>
  <li><a href="#canon-remix" id="toc-canon-remix">CHART 5 - CANON AND REMIX</a></li>
