...
<figure class="art-chart">
  <div class="art-chart-live" data-chart="/data/articles/un-votes/charts/chart1_category.plotly.json" data-fallback="/images/content/articles/un-votes/charts/chart1_category.png" role="img" aria-label="Vote"></div>
  <figcaption class="art-chart-caption">Vote</figcaption>
</figure>
<p class="art-p"><strong>yes</strong> dominates with <strong>79,663</strong> records.</p>
<p class="art-p">The long tail still holds <strong>0</strong> additional vote buckets.</p>
<h2 id="chart-2-leaders" class="anchored">CHART 2 — LEADERS</h2>
<figure class="art-chart">
  <div class="art-chart-live" data-chart="/data/articles/un-votes/charts/chart2_leaders.plotly.json" data-fallback="/images/content/articles/un-votes/charts/chart2_leaders.png" role="img" aria-label="Top Country"></div>
...
<figure class="art-chart">
  <div class="art-chart-live" data-chart="/data/articles/un-votes/charts/chart3_category.plotly.json" data-fallback="/images/content/articles/un-votes/charts/chart3_category.png" role="img" aria-label="Vote"></div>
  <figcaption class="art-chart-caption">Vote</figcaption>
</figure>
...
<figure class="art-chart">
  <div class="art-chart-live" data-chart="/data/articles/un-votes/charts/chart5_frequency.plotly.json" data-fallback="/images/content/articles/un-votes/charts/chart5_frequency.png" role="img" aria-label="Appearance Spread"></div>
...
<figure class="art-chart">
  <div class="art-chart-live" data-chart="/data/articles/un-votes/charts/chart_extra_mix.plotly.json" data-fallback="/images/content/articles/un-votes/charts/chart_extra_mix.png" role="img" aria-label="Country code"></div>
  <figcaption class="art-chart-caption">Country code</figcaption>
</figure>
...
<p>Community-cleaned TidyTuesday snapshots are not live APIs. Missing values, spelling variants, and week-of-export coverage limits apply. Merged tables may fan out or duplicate rows when join keys are imperfect.</p><p>Findings describe the file on hand — treat them as structural signals about <strong>UN Votes</strong>, not exhaustive truth about the full domain.</p>
<h2 id="conclusion" class="anchored">CONCLUSION</h2>
<p>Measured end to end, <strong>UN Votes</strong> rewards counting: the leaders, the long tail, and the time trend rarely tell the same story about the field.</p><p>That tension is the Artometrics mandate — data does not replace judgment, it disciplines it.</p>
