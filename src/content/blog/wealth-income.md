...
slug: wealth-income
pubDate: 2026-06-15
description: "This report analyzes the TidyTuesday 2021-02-09 release on Wealth and Income — 2,916 rows after cleaning and merge. How concentrated is wealth at the top of the distribution?"
...
<p class="art-p">This report analyzes the TidyTuesday <strong>2021-02-09</strong> release on <strong>Wealth and Income</strong> — <strong>2,916</strong> rows after cleaning and merge. How concentrated is wealth at the top of the distribution?</p>
<p class="art-p">Five charts track <strong>Income distribution</strong> across time, category, and named entities — trend, leaders, distribution, tiers, and relationships. Where companion files exist in the repo, they are joined before analysis so reception, geography, or metadata columns are not left on the table.</p>
...
<figure class="art-chart">
  <div class="art-chart-live" data-chart="/data/articles/wealth-income/charts/chart1_trend.plotly.json" data-fallback="/images/content/articles/wealth-income/charts/chart1_trend.png" role="img" aria-label="Median Income distribution Over Time"></div>
...
<figure class="art-chart">
  <div class="art-chart-live" data-chart="/data/articles/wealth-income/charts/chart2_leaders.plotly.json" data-fallback="/images/content/articles/wealth-income/charts/chart2_leaders.png" role="img" aria-label="Top Race"></div>
...
<figure class="art-chart">
  <div class="art-chart-live" data-chart="/data/articles/wealth-income/charts/chart4_category_compare.plotly.json" data-fallback="/images/content/articles/wealth-income/charts/chart4_category_compare.png" role="img" aria-label="Income distribution by Income bracket"></div>
  <figcaption class="art-chart-caption">Income distribution by Income bracket</figcaption>
</figure>
<p class="art-p"><strong>$50,000 to $74,999</strong> leads the median table at <strong>17.5</strong>; the gap to <strong>$150,000 to $199,999</strong> is <strong>13.3</strong> points.</p>
...
<p>Community-cleaned TidyTuesday snapshots are not live APIs. Missing values, spelling variants, and week-of-export coverage limits apply. Merged tables may fan out or duplicate rows when join keys are imperfect.</p><p>Findings describe the file on hand — treat them as structural signals about <strong>Wealth and Income</strong>, not exhaustive truth about the full domain.</p>
<h2 id="conclusion" class="anchored">CONCLUSION</h2>
<p>Measured end to end, <strong>Wealth and Income</strong> rewards counting: the leaders, the long tail, and the time trend rarely tell the same story about income distribution.</p><p>That tension is the Artometrics mandate — data does not replace judgment, it disciplines it.</p>
