...
<figure class="art-chart">
  <div class="art-chart-live" data-chart="/data/articles/netflix-engagement/charts/chart4_category_compare.plotly.json" data-fallback="/images/content/articles/netflix-engagement/charts/chart4_category_compare.png" role="img" aria-label="Hours viewed by Source"></div>
  <figcaption class="art-chart-caption">Hours viewed by Source</figcaption>
</figure>
<p class="art-p"><strong>3_What_We_Watched_A_Netflix_Engagement_Report_2024Jan-Jun</strong> leads the median table at <strong>2,600,000</strong>; the gap to <strong>1_What_We_Watched_A_Netflix_Engagement_Report_2025Jan-Jun</strong> is <strong>300,000</strong> points.</p>
...
<p>Community-cleaned TidyTuesday snapshots are not live APIs. Missing values, spelling variants, and week-of-export coverage limits apply. Merged tables may fan out or duplicate rows when join keys are imperfect.</p><p>Findings describe the file on hand — treat them as structural signals about <strong>Netflix Engagement</strong>, not exhaustive truth about the full domain.</p>
<h2 id="conclusion" class="anchored">CONCLUSION</h2>
<p>Measured end to end, <strong>Netflix Engagement</strong> rewards counting: the leaders, the long tail, and the time trend rarely tell the same story about hours viewed.</p><p>That tension is the Artometrics mandate — data does not replace judgment, it disciplines it.</p>
