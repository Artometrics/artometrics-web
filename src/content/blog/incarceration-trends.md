...
<figure class="art-chart">
  <div class="art-chart-live" data-chart="/data/articles/incarceration-trends/charts/chart1_trend.plotly.json" data-fallback="/images/content/articles/incarceration-trends/charts/chart1_trend.png" role="img" aria-label="Median Population Over Time"></div>
  <figcaption class="art-chart-caption">Median Population Over Time</figcaption>
</figure>
...
<figure class="art-chart">
  <div class="art-chart-live" data-chart="/data/articles/incarceration-trends/charts/chart3_distribution.plotly.json" data-fallback="/images/content/articles/incarceration-trends/charts/chart3_distribution.png" role="img" aria-label="Population by Region"></div>
  <figcaption class="art-chart-caption">Population by Region</figcaption>
</figure>
...
<figure class="art-chart">
  <div class="art-chart-live" data-chart="/data/articles/incarceration-trends/charts/chart4_category_compare.plotly.json" data-fallback="/images/content/articles/incarceration-trends/charts/chart4_category_compare.png" role="img" aria-label="Population by Region"></div>
  <figcaption class="art-chart-caption">Population by Region</figcaption>
</figure>
<p class="art-p"><strong>Northeast</strong> leads the median table at <strong>17,263</strong>; the gap to <strong>Midwest</strong> is <strong>14,986</strong> points.</p>
<p class="art-p">Tier separation matters more than means when distributions skew hard.</p>
<h2 id="chart-5-relationship" class="anchored">CHART 5 — RELATIONSHIP</h2>
<figure class="art-chart">
  <div class="art-chart-live" data-chart="/data/articles/incarceration-trends/charts/chart5_scatter.plotly.json" data-fallback="/images/content/articles/incarceration-trends/charts/chart5_scatter.png" role="img" aria-label="Population vs Pretrial population"></div>
  <figcaption class="art-chart-caption">Population vs Pretrial population</figcaption>
</figure>
...
<p>Community-cleaned TidyTuesday snapshots are not live APIs. Missing values, spelling variants, and week-of-export coverage limits apply. Merged tables may fan out or duplicate rows when join keys are imperfect.</p><p>Findings describe the file on hand — treat them as structural signals about <strong>Incarceration Trends</strong>, not exhaustive truth about the full domain.</p>
<h2 id="conclusion" class="anchored">CONCLUSION</h2>
<p>Measured end to end, <strong>Incarceration Trends</strong> rewards counting: the leaders, the long tail, and the time trend rarely tell the same story about population.</p><p>That tension is the Artometrics mandate — data does not replace judgment, it disciplines it.</p>
