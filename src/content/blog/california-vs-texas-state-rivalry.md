---
title: "CALIFORNIA VS TEXAS: The Artometrics of Rival State Systems"
slug: california-vs-texas-state-rivalry
pubDate: 2026-07-01
description: "A comparative geo-economics report on why California and Texas are paired in public debate, what they share, and where their economies, exports, risks, and identities diverge."
...
<nav id="TOC" role="doc-toc">
  ...
  <li><a href="#why-compared" id="toc-why-compared">CHART 1 - WHY THEY ARE COMPARED</a></li>
  <li><a href="#growth-model" id="toc-growth-model">CHART 2 - GROWTH MODEL</a></li>
  <li><a href="#fingerprint" id="toc-fingerprint">CHART 3 - EXPORT FINGERPRINT</a></li>
  <li><a href="#tradeoffs" id="toc-tradeoffs">CHART 4 - HIDDEN TRADEOFFS</a></li>
...
<p class="art-p">California and Texas are the most common American state comparison because each is large enough to represent a theory of the country. One is the expensive knowledge-and-culture machine; the other is the growth-and-capacity machine.</p>
<p class="art-p">This report does not settle the rivalry. It defines why the rivalry exists and what a serious data comparison should test next.</p>
...
<div class="facts-grid">
  ...
  <div class="fact-box"><span class="fact-number">7</span><span class="fact-label">Export/industry families compared</span></div>
  <div class="fact-box"><span class="fact-number">6</span><span class="fact-label">Next comparison questions</span></div>
...
<p class="art-p">California and Texas are competitors because they are two different answers to the same American question: how should scale, growth, talent, land, energy, and culture be organized?</p>
<p class="art-p">The most important finding is that the comparison is valid, but usually under-asked. Taxes are visible; export identity, climate risk, talent compounding, and cultural magnetism explain more.</p>
