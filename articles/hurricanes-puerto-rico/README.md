...
**Desk:** culture · **Live:** https://artometrics.com/hurricanes-puerto-rico/
...
```bash
cd articles/hurricanes-puerto-rico
quarto render
npm run sync:article -- --slug hurricanes-puerto-rico
```
